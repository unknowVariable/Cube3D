...
void	init_textures(t_config *conf)
{
	...
	conf->mlx.tex_no.addr = mlx_get_data_addr(conf->mlx.tex_no.img, &conf->mlx.tex_no.bpp, &conf->mlx.tex_no.line_len, &conf->mlx.tex_no.endian);
	...
	conf->mlx.tex_so.addr = mlx_get_data_addr(conf->mlx.tex_so.img, &conf->mlx.tex_so.bpp, &conf->mlx.tex_so.line_len, &conf->mlx.tex_so.endian);
	...
	conf->mlx.tex_we.addr = mlx_get_data_addr(conf->mlx.tex_we.img, &conf->mlx.tex_we.bpp, &conf->mlx.tex_we.line_len, &conf->mlx.tex_we.endian);
	...
	conf->mlx.tex_ea.addr = mlx_get_data_addr(conf->mlx.tex_ea.img, &conf->mlx.tex_ea.bpp, &conf->mlx.tex_ea.line_len, &conf->mlx.tex_ea.endian);
}
